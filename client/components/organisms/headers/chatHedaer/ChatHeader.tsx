    ...
    <>
      ...
      >
        <div className='flex items-center justify-center'>
          <Button className="border-0 m-0 p-0 bg-inherit" type="button" onClick={() => router.back()}>
          ...
          >
            <MenuItem className="text-[#63A8DA]" onClick={handleClose}>채팅방 나가기</MenuItem>
            <MenuItem className="text-[#63A8DA]" onClick={handleClose}>신고</MenuItem>
            <MenuItem className="text-[#63A8DA]" onClick={handleClose}>닫기</MenuItem>
          </Menu>
        </div>
      </AppBar>
      <Divider />
