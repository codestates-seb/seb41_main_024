  ...
  return (
    <div className='flex justify-center'>
      <form className='flex flex-col justify-center w-10/12 max-w-lg'>
        <img className='h-40 w-40 mb-7 m-auto' src={base} alt={"유저이미지"}/>
        <Input 
          id={"email-input"}
          name="email"
          type={"text"} 
        ...
        <Input 
          ...
          onChange={onChange}
        />
        <Label htmlFor={"nickName-input"} labelText={"사용가능한 닉네임 입니다"}/>
        <TextField
          id={"password-input"}
          name="password"
          type={"text"} 
          ...
          onChange={onChange}
        />
        <Label htmlFor={"password-input"} labelText={"소문자와 특수문자를 포함한 8글자"}/>
        <TextField 
          ...
          onChange={onChange}
        />
        <Label htmlFor={"password-check-input"} labelText={checkedPasswordRegexText}/>
        <FormButton className='h-14 mt-4' variant='contained' content='수정하기' />
      </form>
    </div>
  )
}
